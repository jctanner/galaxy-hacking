...
SELECT
    ...
    --    WHERE
    --        rvml.repository_version_removed_id=crc.version_removed_id
...
--INNER JOIN
--    RepositoryVersionRemovedLookup rvrl ON rvrl.repository_version_removed_id=crc.version_removed_id
--INNER JOIN
        ...
        (
            (
                SELECT
                    number
                FROM
                    --RepositoryVersionRemovedLookup rvmlx
                    RepositoryVersionNumberLookup rvmlx
                WHERE
                    --rvmlx.repository_version_removed_id=crc.version_removed_id
            ...
            (
                SELECT
                    number
                FROM
                    --RepositoryVersionAddedLookup rvalx
